...
void TutorialGame::InitDefaultFloor() {
	AddFloorToWorld(Vector3(-50, -2, -45));
	AddFloorToWorld(Vector3(-50, -2, 55));
	AddFloorToWorld(Vector3(-50, -2, 155));

	
	AddFloorToWorld(Vector3(50, -2, -45));
	MakeObjectSmooth(AddFloorToWorld(Vector3(50, -2, 55)));
	AddFloorToWorld(Vector3(50, -2, 155));

	AddFloorToWorld(Vector3(150, -2, -45));
	AddFloorToWorld(Vector3(150, -2, 55));
	MakeObjectBounce(AddFloorToWorld(Vector3(150, -2, 155)));
...
void TutorialGame::BuildWalls()
{
	...
	MakeObjectBounce(AddCubeToWorld(Vector3(0, 8, 200), Vector3(100, 10, 5), 0.0f));
	MakeObjectBounce(AddCubeToWorld(Vector3(100, 8, 200), Vector3(100, 10, 5), 0.0f));
	MakeObjectBounce(AddCubeToWorld(Vector3(0, 8, -100), Vector3(100, 10, 5), 0.0f));
	MakeObjectBounce(AddCubeToWorld(Vector3(100, 8, -100), Vector3(100, 10, 5), 0.0f));
...
{
	object->GetPhysicsObject()->SetFriction(0.0001f);
