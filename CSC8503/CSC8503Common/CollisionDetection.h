...
namespace NCL {
	...
	public:
		...
		static bool PlaneSphereIntersection(const Plane& plane, const SphereVolume& volume, const Transform& worldTransform);
		static bool PlaneAABBIntersection(const Plane& plane, const AABBVolume& volume, const Transform& worldTransform);
		static bool PlaneCapsuleIntersection(const Plane& plane, const CapsuleVolume& volume, const Transform& worldTransform);
		...
		static bool SphereCapsuleIntersection(
			...
			const SphereVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		//AABB Capsule
		static bool AABBCapsuleIntersection(const AABBVolume& volumeA, const Transform& worldTransformA, const CapsuleVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		//OBB Capsule
		static bool OBBCapsuleIntersection(const OBBVolume& volumeA, const Transform& worldTransformA, const CapsuleVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		// OBB AABB
		static bool OBBAABBIntersection(const OBBVolume& volumeA, const Transform& worldTransformA, const AABBVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo);
		//OBB Sphere
		...
		static Vector3 AABBSupport(const Transform& worldTransform, Vector3 worldDir);
